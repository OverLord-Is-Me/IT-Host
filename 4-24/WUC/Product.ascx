<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Product.ascx.cs" Inherits="WUC_Product" %>
<script runat="server">
                ...
                <table align="center" class="style4">
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Algerian" 
                                ...
                                Text="Search For Product!!!"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: center">
                    ...
                    <tr>
                        ...
                        <td class="style6">
                            &nbsp;<asp:RadioButtonList ID="RBLsearch1" runat="server" Font-Names="Algerian" 
                                ...
                                <asp:ListItem Value="ProId">Product ID</asp:ListItem>
                                <asp:ListItem Value="ProName">Product Name</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="txtsrch" runat="server" style="text-align: center" 
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <asp:Button ID="btnupdt" runat="server" ForeColor="#999999" Height="35px" 
            ...
            <asp:View ID="View2" runat="server">
                ...
                <table align="center" class="style11">
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Names="Algerian" 
                                Font-Size="XX-Large" Height="50px" Text="Add Product" Width="300px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label16" runat="server" Font-Names="Algerian" 
                                Font-Size="X-Large" Text="Category"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:TextBox ID="txt1" runat="server" Enabled="False" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="txt1" ErrorMessage="*" ForeColor="Red" 
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:TextBox ID="txt2" runat="server" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ControlToValidate="txt2" ErrorMessage="*" ForeColor="Red" 
                                ValidationGroup="a"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label17" runat="server" Font-Names="Algerian" 
                                Font-Size="X-Large" Text="Product Price"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txt3" runat="server" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ControlToValidate="txt3" ErrorMessage="*" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label18" runat="server" Font-Names="Algerian" 
                                Font-Size="X-Large" Text="Quantity Available"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txt4" runat="server" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                ControlToValidate="txt4" ErrorMessage="*" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label19" runat="server" Font-Names="Algerian" 
                                Font-Size="X-Large" Text="Time"></asp:Label>
                        </td>
                        <td class="style9">
                            <asp:TextBox ID="txt6" runat="server" Enabled="False" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="style9">
                            <asp:TextBox ID="txt5" runat="server" TextMode="MultiLine" Width="180px"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                ControlToValidate="txt5" ErrorMessage="*" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnrtrn" runat="server" Height="35px" onclick="Button4_Click" 
