...
public class Register : ControlingClass
{
    ...
    public DataTable Searchh(string Field, string Value)
    {
        string query = string.Format("select FullName,Password,NationalId,Email,PhonNo From Register Where {0} like'%{1}%' ", Field, Value);
