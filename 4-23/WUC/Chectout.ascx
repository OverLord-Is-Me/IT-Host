...
<%@ Register src="LogForCheckout.ascx" tagname="LogForCheckout" tagprefix="uc2" %>
<style type="text/css">
    .style1
    {}
    .style18
    ...
    <tr>
        <td>
            <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" BackColor="#EFF3FB" 
                BorderColor="#B5C7DE" BorderWidth="1px" Font-Names="Verdana" Font-Size="1.2em" 
                ...
                <WizardSteps>
                    <asp:WizardStep runat="server" StepType="Start" title="Login">
                        <uc2:LogForCheckout ID="LogForCheckout1" runat="server" />
                    </asp:WizardStep>
                    <asp:WizardStep runat="server" title="DeliveryAddress">
                        <table align="center">
                            ...
                            <tr>
                                ...
                                <td class="style4">
                                    <asp:TextBox ID="txtcity" runat="server" Height="22px" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                ...
                                <td>
                                    <asp:TextBox ID="txtarea" runat="server" Height="22px" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="style2">
                                ...
                                <td>
                                    <asp:TextBox ID="txtaddress" runat="server" TextMode="DateTimeLocal" 
