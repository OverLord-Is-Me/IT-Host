...
public class Driver : ControlingClass
{
   ...
   public string AddDr(string Name, string Password, string NationalId, string Address, string Email, string PhoneNumber)
    {
        this.Name = Name; this.Password = Password;
        this.NationalId = NationalId;   this.Address = Address;
