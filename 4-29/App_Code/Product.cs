...
public class Product : ControlingClass
{
    ...
    public string AddPro(string ProName, string ProPrice, string Avqty, string WritingData, string ProDetails)
    {
        this.ProName = ProName; this.ProPrice = ProPrice;
        this.Avqty = Avqty; this.WritingData = WritingData;
