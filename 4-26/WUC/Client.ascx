<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Client.ascx.cs" Inherits="WUC_WebUserControl2" %>
<style type="text/css">
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <asp:ImageButton ID="ImageButton5" runat="server" Height="100px" 
                        ImageUrl="~/IMG/special-offer-300.jpg" Width="200px" />
                </td>
            </tr>
            <tr>
                <td class="style31">
                ...
                <td style="text-align: center">
                    <asp:Label ID="Label3" runat="server" Font-Names="Edwardian Script ITC" 
                        Font-Size="XX-Large" ForeColor="#0099FF" Text="Special Offer"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style31">
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <asp:ImageButton ID="ImageButton7" runat="server" Height="100px" 
                        ImageUrl="~/IMG/shopping_cart_racing.png" Width="200px" />
                </td>
            </tr>
            <tr>
                <td class="style31">
                ...
                <td style="text-align: center">
                    <asp:Label ID="Label6" runat="server" Font-Names="Edwardian Script ITC" 
                        Font-Size="XX-Large" ForeColor="#0099FF" Text="Cart"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style31">
