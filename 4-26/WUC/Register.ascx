        ...
        <table class="style1" style="text-align: center;">
            ...
            <tr>
                <td class="style16" height="35">
                    &nbsp;</td>
                <td height="35">
                    <asp:Label ID="lblrepassword" runat="server" Font-Names="Segoe Print" 
                        Font-Size="Large" height="28px" Text="Re-Password"></asp:Label>
                </td>
                <td class="style2" height="35" 
                    style="line-height: inherit; vertical-align: inherit">
                    <asp:TextBox ID="txtrepassword" runat="server" Font-Names="MV Boli" 
                        Font-Size="Large" ForeColor="#0033CC" height="28px" TextMode="Password" 
                ...
                <td class="auto-style9" height="35">
                    <asp:CompareValidator ID="CompareValidator3" runat="server" 
                        ...
                        Font-Size="Small" ForeColor="Red" ValidationGroup="reg">
            ...
            <tr>
                <td class="style17" aria-multiline="True">
                    &nbsp;</td>
                <td class="style14">
                ...
                <td class="auto-style10">
                    <asp:CompareValidator ID="CompareValidator6" runat="server" 
                        ControlToValidate="txtnationaid" ErrorMessage="Check  your National Id" 
                        Font-Names="Ebrima" Font-Size="Small" ForeColor="Red" Operator="LessThanEqual" 
                        Type="Double" ValidationGroup="reg" ValueToCompare="99999999999999"></asp:CompareValidator>
                </td>
                <td class="style14"></td>
            </tr>
            <tr>
                ...
                <td height="35" class="auto-style9">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ...
                        Font-Names="Ebrima" Font-Size="Small" ForeColor="Red" 
            ...
            <tr>
                ...
                <td height="35" class="auto-style9">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ...
                        Font-Names="Ebrima" Font-Size="Small" ForeColor="Red" ValidationGroup="reg"></asp:RequiredFieldValidator>
                </td>
                <td height="35">&nbsp;</td>
            </tr>
            <tr>
